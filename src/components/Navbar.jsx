...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between h-20 px-6 md:px-10'>
     ...
     <div onClick={handleNav} className=' block md:hidden text-white px-2 rounded-xl p-1'>
     ...
     <h1 className=' w-full text-3xl font-bold text-[#00df9a] m-4 ml-7'>AADITYA.</h1>
        ...
        <li className="p-4 border-b border-gray-500"><a href="#about">About</a></li>
        <li className="p-4 border-b border-gray-500"><a href="#portfolio">Portfolio</a></li>
        <li className="p-4 border-b border-gray-500"><a href="#resume">Resume</a></li>
